	...
	std::vector<Box> &boxes)
{
	...
	static GLTexture texture = ResourceManager::getTexture("../res/textures/platform_tutorial/bricks_top.png");
	...
	static GLTexture boxTexture = ResourceManager::getTexture("../res/textures/platform_tutorial/bricks_top.png");
	Colour boxColour(255, 0, 0, 255);
